...
function typeWriter() {
    if (i < txt1.length) {
        if (txt1.charAt(i) == '<')
            ...
            $(".bg_heart").css("background-image", "url('https://images.unsplash.com/photo-1604323990536-e5452c0507c1?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')");
